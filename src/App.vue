  ...
  <div id="app">
    <nav class="navbar navbar-expand navbar-light bg-white">
      ...
      <div class="navbar-nav mr-auto">
        <li class="nav-item">
          <router-link to="/mission_commander" class="nav-link">Mission Commanders</router-link>
        </li>
        <li class="nav-item">
          <router-link to="/addCommander" class="nav-link">Agregar Mission Commander</router-link>
        </li>
        <li class="nav-item">
